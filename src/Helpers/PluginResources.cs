namespace Loupedeck.PomodoroClockPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.PomodoroClockPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.PomodoroClockPlugin.Resources.Resource.txt`.
